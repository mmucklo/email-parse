...
> **Companion documents:** [CHANGELOG.md](CHANGELOG.md) (per-version changes), [ROADMAP.md](ROADMAP.md) (planned work), [UPGRADE.md](UPGRADE.md) (v2.x → v3.0 migration).
...
- **RFC 3696** (2004) - Application Techniques for Checking and Transformation of Names (EID 1690: 254-octet total limit)
...
| Rule                          | rfc5321 | rfc6531 | rfc5322 | rfc2822 | legacy |
|-------------------------------|:-------:|:-------:|:-------:|:-------:|:------:|
| `allowUtf8LocalPart`          |    ·    |    ✓    |    ·    |    ·    |   ✓    |
| `allowObsLocalPart`           |    ·    |    ·    |    ✓    |    ✓    |   ·    |
| `allowQuotedString`           |    ✓    |    ✓    |    ✓    |    ✓    |   ✓    |
